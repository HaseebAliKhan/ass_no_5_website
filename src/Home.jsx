        ...
        <div className='container-fluid  '>
          <div className='row'>
            <div className='col-10 mx-auto '>
              <div className='row '>
                <div className='col-md-5 pt-5 pt-lg-5 order-2 order-lg-1  d-flex justify-content-center flex-column '>
                ...
                <div className='col-lg-7 order-lg-2  order-1 header-img header-container-image '>
